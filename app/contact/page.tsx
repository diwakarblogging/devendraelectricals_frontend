...
export default function ContactPage() {
  ...
  const contactInfo = [
    { icon: Phone, label: 'Phone', value: settings.phoneNumber, href: `tel:${settings.phoneNumber}` },
    { icon: Mail, label: 'Email', value: settings.shopEmail, href: `mailto:${settings.shopEmail}` },
    { icon: MapPin, label: 'Address', value: settings.shopAddress },
