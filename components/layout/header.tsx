        ...
        <div className="hidden lg:block border-b border-primary-700 bg-primary-800/50">
          <div className="container mx-auto flex items-center justify-between py-2 text-xs text-primary-300">
            ...
            <div className="flex items-center gap-4">
              <a href={`tel:${settings.phoneNumber}`} className="hover:text-brand-500 transition-colors">
                <Phone className="inline h-3 w-3 mr-1" /> {settings.phoneNumber}
              </a>
              <a href={getWhatsAppUrl(undefined, settings.whatsappNumber)} target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 transition-colors">
                WhatsApp
              </a>
            </div>
          </div>
          ...
          >
            <div className="container mx-auto py-4 space-y-1">
              ...
              <div className="border-t border-primary-700 pt-3 mt-3 px-4">
                <a href={`tel:${settings.phoneNumber}`} className="flex items-center gap-2 text-sm text-primary-300 hover:text-white mb-2">
                  <Phone className="h-4 w-4" /> {settings.phoneNumber}
                </a>
              </div>
            </div>
          </motion.div>
